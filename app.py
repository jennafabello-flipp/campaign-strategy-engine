    ...
    if merch_file and df_clean is not None:
        ...
        with tab_l1:
            ...
            with col_c1: 
                ...
                fig_l1.add_scatter(x=l1_sorted['L1_Category'], y=l1_sorted['Clip Share %'], mode='lines+markers', name='Add to List %', line=dict(color='#ffaf15', width=3), marker=dict(size=8))
                fig_l1.update_layout(title=dict(text="L1 Category Share Allocation", x=0.5, xanchor='center', xref='paper', font=dict(family='Arial', size=16)), yaxis=dict(title="% to Total", tickformat='.1%'), xaxis=dict(title=None), legend=dict(title=None))
        ...
        with tab_l2:
            ...
            with col_c2: 
                ...
                fig_l2.update_layout(title=dict(text="L2 Subcategory Share Allocation", x=0.5, xanchor='center', xref='paper', font=dict(family='Arial', size=16)), yaxis=dict(title="% to Total", tickformat='.1%'), xaxis=dict(title=None), legend=dict(title=None))
        ...
        with tab_l3:
            ...
            with col_c3: 
                ...
                fig_l3.update_layout(title=dict(text="L3 Sub-subcategory Share Allocation", x=0.5, xanchor='center', xref='paper', font=dict(family='Arial', size=16)), yaxis=dict(title="% to Total", tickformat='.1%'), xaxis=dict(title=None), legend=dict(title=None))
